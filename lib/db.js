...
export const emotionData = [
  ...
  },
  {
    ...
    subemotions: ["amazement", "astonishment", "wonder"],
  },
  {
    name: "Fear",
    slug: "fear",
...
export const shortEmotionDescriptions = {
  Joy: "Enjoyment is, for many, the most desirable of the seven …",
  Surprise: "Surprise is one of the seven universal emotions and arises ...",
  Fear: "Fear is one of the seven universal emotions experienced … ",
  Sadness: "Sadness is one of the seven universal emotions experienced ...",
  Contempt:
    "The least researched of the seven universal emotions, contempt ...",
  Disgust: "Disgust is one of the seven universal emotions and ... ",
  Anger: "Anger is one of the seven universal emotions which arises ...",
};
