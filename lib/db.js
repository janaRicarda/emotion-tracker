...
export const manualData = [
  ...
  },
  {
    ...
    answers: [
      "Logo: By clicking on the logo, you are redirected back to the main landing page, regardless of your current location within the app.",
      "Sun: Easily switch between light and dark mode with the sun and moon icons, ensuring optimal viewing comfort regardless of the ambient lighting conditions.",
      "Menu: The burger menu icon provides quick access to additional navigation options and features.",
    ],
  },
];
