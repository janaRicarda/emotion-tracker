...
export const manualData = [
  ...
  },
  {
    ...
    text: "The perception of emotions is deeply personal - like the perception of colors. We want you to make the best possible experience while recording your emotions, so we provide yo a range of themes where you can pick the one, that suits you most. When you click on the menu button, click on colorschemes and pick your's.",
    answers: [
      "There are some common associations between emotions and colors and mybe that suits you perfectly -> go for what a feeling theme",
      "Maybe you are a synaesthetic person and for some unexplainable reasons you feel calm and comfortable with so called 'warm' colors -> go for warm theme",
      "or vice versa -> go for cold theme",
      "Perhaps you dont like colors at all -> go for neutral theme",
      "Or maybe your perception dont want to differ between colors -> go for high contrast theme",
    ],
  },
];
