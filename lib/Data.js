const emotionData = [
  ...
  },
  {
    ...
    function: "The function of surprise is to focus our attention so we can determine what is happening and whether we are in danger or not."
...

  {
    ...
    function: "The universal function of sadness is to, in some way, signal for help. This can be a signal to others saying that we need comforting, or to ourselves to take some time and recoup from our loss."
    ...
    subemotions: ["Disappointment", "Discouragement", "Distraughtness", "Resignation", "Helplessness", "Hopelessness", "Misery", "Despair"],
    color: "hsl(200, 80%, 70%)",
  },
  {
    name: "Contempt",
    ...
    function: "It’s widely believed that the function of contempt is to signal a feeling of superiority, of not needing to accomodate or engage, and to assert power or status."
  ...
  },
  {
    ...
    function: "The universal function of disgust is to get away from, block off, or eliminate something offensive, toxic or contaminating."
    ...
    subemotions: ["Dislike", "Aversion", "Distate", "Repugnance", "Revulsion", "Abhorremce", "Loathing"],
    color: "hsl(310, 80%, 70%)",
  },
  {
    name: "Anger",
    ...
    subemotions: ["Annoyance", "Frustration", "Exasperation", "Argumantativeness", "Bitterness", "Vengefulness", "Fury"],
    color: "hsl(10, 80%, 70%)",
  },
];
